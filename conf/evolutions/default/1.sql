...
create table "RECIPES" ("ID" SERIAL NOT NULL PRIMARY KEY,"NAME" VARCHAR(254) NOT NULL,"DESCRIPTION" VARCHAR(254) NOT NULL,"INSTRUCTIONS" VARCHAR(254) NOT NULL,"USER_ID" BIGINT NOT NULL);
